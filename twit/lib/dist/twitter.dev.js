...
var request = request = require("request").defaults({
  proxy: config.proxy // rejectUnauthorized: false,
...
var Twitter = function Twitter(config) {
...
Twitter.prototype._validateConfigOrThrow = function (config) {
  ...
  if (_typeof(config) !== 'object') {
    throw new TypeError('config must be object, got ' + _typeof(config));
  }
